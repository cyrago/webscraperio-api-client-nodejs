...
export class Client {
    ...
    getSitemaps(tag) {
        return new PaginationGenerator(this.httpClient, "sitemaps", tag ? { tag } : undefined);
    }
    ...
    getScrapingJobs(query) {
        return new PaginationGenerator(this.httpClient, "scraping-jobs", query);
    }
    ...
    getProblematicUrls(scrapingJobId) {
        return new PaginationGenerator(this.httpClient, `scraping-job/${scrapingJobId}/problematic-urls`);
    }
